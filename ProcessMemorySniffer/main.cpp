...
/// <summary>
/// Wide-character program entry point that collects process information, prints the top 15 processes by working set, and reports errors to standard error.
/// </summary>
/// <returns>EXIT_SUCCESS on success; EXIT_FAILURE if an exception (Win32Error or std::exception) is thrown and handled.</returns>
int wmain()
{
	try
	{
